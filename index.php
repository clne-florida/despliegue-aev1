...
$palabras = ['elefante', 'jirafa', 'hipopotamo', 'rinoceronte', 'cocodrilo', 'camello', 'chimpance', 'capibara', 'ornitorrinco', 'castor', 'dodo'];
...
<body>
    ...
    <form method="post">
        <label for="letra">
          <span>Introduce una letra:</span>
        <input type="text" name="letra" id="letra" maxlength="1" required placeholder="Letra">
        </label>
